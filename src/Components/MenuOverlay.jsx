    ...
    >
      ...
      <div className="h-16 w-full flex">
        <div className="h-full w-[50%] flex justify-center items-center">   
          <button className="font-bold text-xl w-8 h-8 border-[#e8e6ce] border-2 rounded-md flex justify-center items-center">
            <LuSunMedium />
          </button>
        </div>
        <div className="h-full w-[50%] flex gap-2 justify-center items-center">
            <p className="font-bold text-xl -mb-1">ENG</p>
            <p className="font-bold text-xl">|</p>
            <p className="font-bold text-xl -mb-1">EST</p>
        </div>
      </div>
    </nav>
  );
