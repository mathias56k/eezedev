...
const Features = () => {
  return (
    <div className="my-10">
        <div className="bg-red-900 w-full h-[50rem] flex flex-col md:grid md:grid-rows-3 md:grid-cols-2 md:h-auto md:my-16 md:gap-2 xl:grid-cols-3 xl:grid-rows-2">
            <div className="bg-blue-900 w-full h-[20%] flex items-start justify-center pt-2 md:row-span-1 md:col-span-1 md:h-[10rem]">
                <div className="flex items-center w-[45%] justify-left">
